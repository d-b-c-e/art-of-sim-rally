...
```powershell
./tools/testing/Test-Rc.ps1 -Version 0.2.4-rc.5
# Once real cases exist, include them on every candidate:
./tools/testing/Test-Rc.ps1 -Version 0.2.4-rc.6 -Corpus './results/regression-corpus/index.json'
# Validate the exact final-labelled artifact with the same offline suite:
./tools/testing/Test-Rc.ps1 -Version 0.2.4 -Final
```

RC1/RC2 exist, RC3 stopped before packaging, and the [feedback review](reviews/2026-09-08-feedback-review.md)
tracks RC4. Choose a new RC number for every rebuild. Existing ZIPs/staging directories are
